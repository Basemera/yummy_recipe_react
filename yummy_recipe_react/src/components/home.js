      ...
      <div className="background">
        ...
        <div id="carouselExampleIndicators" className="carousel slide carouse-slider" data-ride="carousel">
          ...
          <div className="carousel-inner">
            ...
            <h5 className="caption-header">Welcome to Yummy Recipes app.</h5>
            <p>One thousand flavors in one place. Put your recipes down in one place.</p>
          </div>
            </div>
            ...
            <p>Found that magical ingredient edit your recipe to include it</p>
      </div>
          </div>
            </div>
            <div className="carousel-item">
            ...
            <h5 className="caption-header">Manage your recipes</h5>
            <p>This app will help you to manage your
                    recipes. If you have already signed up please login to continue.
      If not please signup to enjoy.</p>
          </div>
            </div>
          </div>
